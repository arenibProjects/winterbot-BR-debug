exports.init=function(displayer,xCom){
	...
	var placementCardActions=[
		v=>{xCom.send(["SPOS",v,exports.placementCardRows[1][0].value,exports.placementCardRows[2][0].value],"motionbase")},
		v=>{xCom.send(["SPOS",exports.placementCardRows[0][0].value,v,exports.placementCardRows[2][0].value],"motionbase")},
		v=>{xCom.send(["SPOS",exports.placementCardRows[0][0].value,exports.placementCardRows[1][0].value,v],"motionbase")}
	];
